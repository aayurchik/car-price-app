...
## 1. Что было сделано  (в оформлении помог ИИ)
   ...
   - Пропуски заполнены медианой, `torque` удалён.  
...
### 5.2 Визуализация  
- Тепловая карта корреляций показала сильные и слабые связи между признаками. Видно распределение цены, описательные статистики.  
...
- Кажется у меня в приложении модель в прогнозе плохо реагирует на переменную seats, не вижу изменений в цифрах. 
